...
- **Command**: Which command to use (prefer: /onboard, /normalize, /colorize, /polish, /harden, /optimize, /clarify, /delight, /extract, /distill, /bolder, /quieter, /critique, /adapt, /audit, /animate — or other installed skills you're sure exist)
